...
The highest scoring players by points and if there on a ranked team or not. This will help us to predict if a high scoring player is on a ranked team or not. It turns out points were not a good indicator to determine if there on a ranked team or not.
